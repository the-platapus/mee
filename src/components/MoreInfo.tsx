  ...
  return (
    <div id="more-info" className="m-0 text-left w-full bg-transparent break-words snap-start">
      <div className="main-caption">
        <h2 className="text-center text-[#d8933f] leading-[27px] text-xl font-montserrat font-[200] m-0">
          Hi, I&apos;m Abdullah Aamir.
        </h2>
        <h2 className="text-center text-[#d8933f] leading-[27px] text-xl font-montserrat font-[600] m-0">
      ...
      <div className="sub-caption glass flex gap-[3vh] p-[3.5%] flex-col sm:flex-row">
        <div className="quotes">
          <h2 className="text-[29px] font-lexend font-normal leading-[47px] m-0 text-[white] pb-0">
            &quot;Those who look for seashells will find seashells; those who open them will find pearls.&quot;
          </h2>
          <h3 className="text-[15px] font-lexend font-light leading-[30px] m-0 text-[white] pt-0">
            -Al-Ghazali
          </h3>
        </div>
        <div className="aim">
          <h2 className="text-[69px] text-left font-lexend font-large leading-[1.2] m-0 text-[white] mb-4">
            I aim
          </h2>
          <h3 className="text-[15px] text-left font-lexend font-light leading-[27px] m-0 text-[white] pt-0">
